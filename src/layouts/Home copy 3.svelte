<script>
  ...
  onMount(() => {
    ...
    fetch(API_URL+'/api/sync/info').then(r=>r.json()).then(data=>{
      console.log(data);
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        ...
        <p class="text-muted small mb-4">
          {t("Smart ERP solution for modern businesses. Manage inventory, finance, users, reports and operations in one platform.")}
        </p>
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled footer-links">
          ...
          <li class="mb-3">
            ...
            <span>{t('Address: Shahr-e-naw, Hajji Yaqub Square, GM Mall, Office No. D1-11, Kabul, Afghanistan')}</span>
          </li>
        </ul>
      </div>
